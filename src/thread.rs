...
use syscall::{clone, exit, sched_yield, nanosleep, waitpid, CLONE_VM, CLONE_FS, CLONE_FILES,
              TimeSpec};
          ...
          T: Send + 'static
{
    ...
    match unsafe { clone(CLONE_VM | CLONE_FS | CLONE_FILES).unwrap() } {
        0 => {
